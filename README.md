...
- `attn_implementation="flex_attention"` by default, with `flash-attn` installed for FA2 fallback
- a small Qwen3.5 compatibility flag so Transformers will dispatch FlexAttention for this architecture
...
Switch attention backends or disable compile for the fastest smoke test:
